 ...
 * Handles switching between Turkish, English, and automatic (system) language
 */
public class LanguageManager {
     ...
     * @return Language code (auto, tr, en)
     */
     ...
     * @param languageCode The language code to set (auto, tr, en)
     */
