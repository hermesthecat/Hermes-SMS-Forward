 ...
 * Handles switching between Turkish, English, German, Italian, French, and automatic (system) language
 */
public class LanguageManager {
     ...
     * @return Language code (auto, tr, en, de, it, fr)
     */
     ...
     * @param languageCode The language code to set (auto, tr, en, de, it, fr)
     */
